...
public class PageNewGameNames {
    ...
    @Test
    public void test_new_game_names_page_filling_name() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.names);

        String name = Constants.default_name;
        String input_last_char = name.substring(name.length() - 1);
    ...
    @Test
    public void test_new_game_names_page_label_info_exist() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.names);
    ...
    @Test
    public void test_new_game_names_page_label_info_name() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.names);
    ...
    @Test
    public void test_new_game_names_page_label_warning_exist() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.names);
    ...
    @Test
    public void test_new_game_names_page_label_warning_name_before_mistake() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.names);
    ...
    @Test
    public void test_new_game_names_page_label_warning_name_after_mistake() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.names);

        String expected_text = Constants.warning_text;

        WebElement inputs_in_start_game = CommonMethods.wait_element(DomHelper.input_in_start_game);
        inputs_in_start_game.sendKeys(Constants.name_to_get_warning);
    ...
    @Test
    public void test_new_game_names_page_input_words_exist() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.names);
    ...
    @Test
    public void test_new_game_names_page_button_send_exist() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.names);
    ...
    @Test
    public void test_new_game_names_page_button_send_clickable() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.names);
    ...
    @Test
    public void test_new_game_names_page_button_send_name() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.names);
    ...
    @Test
    public void test_new_game_names_page_button_surrender_exist() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.names);
    ...
    @Test
    public void test_new_game_names_page_button_surrender_clickable() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.names);
    ...
    @Test
    public void test_new_game_names_page_button_surrender_name() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.names);
