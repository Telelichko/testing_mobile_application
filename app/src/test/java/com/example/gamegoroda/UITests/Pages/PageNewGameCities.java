...
public class PageNewGameCities {
    ...
    // ! Добавить тест на повторны ввод города!!!

    @Test
    public void test_new_game_cities_page_filling_city() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.cities);

        String city = Constants.default_city;
        String input_last_char = city.substring(city.length() - 1);
    ...
    // Доработать тест на повторный ввод города
    @Test
    public void test_new_game_cities_page_enter_city_two_times() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.cities);
    ...
    @Test
    public void test_new_game_cities_page_label_info_exist() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.cities);
    ...
    @Test
    public void test_new_game_cities_page_label_info_name() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.cities);
    ...
    @Test
    public void test_new_game_cities_page_label_warning_exist() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.cities);
    ...
    @Test
    public void test_new_game_cities_page_label_warning_name_before_mistake() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.cities);
    ...
    @Test
    public void test_new_game_cities_page_label_warning_name_after_mistake() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.cities);

        String expected_text = Constants.warning_text;

        WebElement inputs_in_start_game = CommonMethods.wait_element(DomHelper.input_in_start_game);
        inputs_in_start_game.sendKeys(Constants.city_to_get_warning);
    ...
    @Test
    public void test_new_game_cities_page_input_words_exist() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.cities);
    ...
    @Test
    public void test_new_game_cities_page_button_send_exist() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.cities);
    ...
    @Test
    public void test_new_game_cities_page_button_send_clickable() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.cities);
    ...
    @Test
    public void test_new_game_cities_page_button_send_name() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.cities);
    ...
    @Test
    public void test_new_game_cities_page_button_surrender_exist() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.cities);
    ...
    @Test
    public void test_new_game_cities_page_button_surrender_clickable() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.cities);
    ...
    @Test
    public void test_new_game_cities_page_button_surrender_name() throws Exception {
        CommonMethods.go_to_new_game_page(Constants.cities);
